...
public class RoomProperties {
    ...
    public static final int DOUBLE_OR_SUITE_ROOM_MAX_OCCUPANCY = 2;
    public static final int DELUXE_ROOM_MAX_OCCUPANCY = 3;

    public static final double SINGLE_ROOM_PRICE = 110d;
}
